...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form method="post" action="insert_course.php" class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" formaction="insert_curriculum.php" class="btn btn-primary">Add Subject</button>
      </div>
    </form>
  </div>
</div>
