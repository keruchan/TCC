        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li><a href="curriculum.php"><i class="ti-files"></i>Subjects</a></li>
                    <li><a href="course.php"><i class="ti-files"></i>Submit credentials</a></li>
                    <li><a href="subject.php"><i class="ti-files"></i>Profile</a></li>
